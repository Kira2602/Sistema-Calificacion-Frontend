  ...
  <div class="crear-usuario">
    ...
    <div v-if="showModal" class="modal-overlay">
      <div class="modal-container success-modal">
        ...
        <h3>Docente Creado Exitosamente</h3>
        <p>El docente {{ nuevoUsuarioNombre }} ha sido registrado correctamente.</p>
...
const cargarDocentes = () => {
  ...
  if (stored) {
    docentes.value = JSON.parse(stored)
  }
}
...
const crearUsuario = () => {
  ...
  localStorage.setItem('docentes', JSON.stringify(docentes.value))
  
  registrarLog('Crear Docente', `Se creó el docente: ${nuevoDocente.nombre}`)
